...
class BottomSelectionScreen extends StatelessWidget {
  const BottomSelectionScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<String>? bottomSelectionList = [];
    return Scaffold(
      body: Padding(
            ...
            child: Column(
              children: [
                ...
                _TopList(
                  ...
                  selectionList: bottomSelectionList,
                ),
                BackNextButtons(
                  onNextPressed: () async {
