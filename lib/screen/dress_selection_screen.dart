...
class DressSelectionScreen extends StatelessWidget {
  const DressSelectionScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<String>? dressSelectionList = [];
    return Scaffold(
      body: Padding(
  ...
  List<ItemModel> pickClothesListRandomly() {
    ...
    for (int i = 0; i < 18; i++) {
      int randomIndex = random.nextInt(dressClothesNameList.length);
      final selectedClothesName = dressClothesNameList[randomIndex];
